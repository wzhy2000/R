...
testR( 1, par, "power.L1.mn.ar1.500.rdata",  nsample =  500, phe.dist = "mn", phe.cov  = "ar1", nloop = n.loop, nrep = n.rep, ncores = ncores);
testR( 1, par, "power.L1.mn.ar1.1000.rdata", nsample = 1000, phe.dist = "mn", phe.cov  = "ar1", nloop = n.loop, nrep = n.rep, ncores = ncores);
testR( 1, par, "power.L1.mn.ar1.2500.rdata", nsample = 2500, phe.dist = "mn", phe.cov  = "ar1", nloop = n.loop, nrep = n.rep, ncores = ncores);
...
par$sig_b <- 0.8
par$sig_e <- 0.2
testR( 1, par, "power.L4.mn.ar1.500.rdata",  nsample =  500, phe.dist = "mn", phe.cov  = "ar1", nloop = n.loop, nrep = n.rep, ncores = ncores);
testR( 1, par, "power.L4.mn.ar1.1000.rdata", nsample = 1000, phe.dist = "mn", phe.cov  = "ar1", nloop = n.loop, nrep = n.rep, ncores = ncores);
testR( 1, par, "power.L4.mn.ar1.2500.rdata", nsample = 2500, phe.dist = "mn", phe.cov  = "ar1", nloop = n.loop, nrep = n.rep, ncores = ncores);

par$sig_a <- 0.8
par$sig_b <- 0.2
par$sig_e <- 0.8
testR( 1, par, "power.L5.mn.ar1.500.rdata",  nsample =  500, phe.dist = "mn", phe.cov  = "ar1", nloop = n.loop, nrep = n.rep, ncores = ncores);
testR( 1, par, "power.L5.mn.ar1.1000.rdata", nsample = 1000, phe.dist = "mn", phe.cov  = "ar1", nloop = n.loop, nrep = n.rep, ncores = ncores);
testR( 1, par, "power.L5.mn.ar1.2500.rdata", nsample = 2500, phe.dist = "mn", phe.cov  = "ar1", nloop = n.loop, nrep = n.rep, ncores = ncores);
...
par$sig_b <- 0.8
par$sig_e <- 0.8
testR( 1, par, "power.L12.mn.sad.500.rdata",  nsample =  500, phe.dist = "mn", phe.cov  = "sad", nloop = n.loop, nrep = n.rep, ncores = ncores);
testR( 1, par, "power.L12.mn.sad.1000.rdata", nsample = 1000, phe.dist = "mn", phe.cov  = "sad", nloop = n.loop, nrep = n.rep, ncores = ncores);
testR( 1, par, "power.L12.mn.sad.2500.rdata", nsample = 2500, phe.dist = "mn", phe.cov  = "sad", nloop = n.loop, nrep = n.rep, ncores = ncores);
...
par$sig_b <- 0.8
par$sig_e <- 0.8
testR( 1, par, "power.L14.mn.cm.500.rdata",  nsample =  500, phe.dist = "mn", phe.cov  = "cm", nloop = n.loop, nrep = n.rep, ncores = ncores);
testR( 1, par, "power.L14.mn.cm.1000.rdata", nsample = 1000, phe.dist = "mn", phe.cov  = "cm", nloop = n.loop, nrep = n.rep, ncores = ncores);
testR( 1, par, "power.L14.mn.cm.2500.rdata", nsample = 2500, phe.dist = "mn", phe.cov  = "cm", nloop = n.loop, nrep = n.rep, ncores = ncores);
